...
import static onlineexam.FXMLConst.TEST_FXML;
            ...
            if (toggleGroup.getSelectedToggle() != null) {
                if (!isAnswered) 
                   ...
                   // disableRadioButtons(true);
                    ...
                    Question ques = quesList.get(curQuesNo);
...
/*insert value in Answer table*/
                ...
                /*    a1.setId(ques.getId());
                    ...
                    try {
                     File f = new File("c:\\programdata\\invoice1.txt");
    ...
    private void populate(int quesNo) {
        ...
        Question q1 = quesList.get(quesNo);
    ...
    public void randomizeQuestion() {
        LinkedList<Question> randomList = new LinkedList<Question>();
   ...
   //coding for timer
            ...
            public void run() {
               //lblTimer.setText(""+setInterval());
                Platform.runLater(new Runnable() {
                   ...
                   lblTimer1.setText(":" + setInterval());
                   lblTimer2.setText(""+count);
                   }
               });
            }
    ...
    public int setInterval(){
        ...
        if(count==0){
            ...
            try { a1.setQues(CLoginFXMLController.cEmail );
                    a1.setScore(score);
                    a1.setCorretAns(""+Correcount);
                    a1.setSelectAns(""+selectedCount);
                    AnswerDao.insert(a1);
     ...
     private  void printInvoice(){
         try {
            ...
            File f = new File("d:\\OnlineExam\\"+a+".html");
            FileOutputStream out = new FileOutputStream(f);
            PrintWriter pr = new PrintWriter(out);
            pr.write("<html>"
